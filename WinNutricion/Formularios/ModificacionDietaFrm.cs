...
{
    public partial class ModificacionDietaFrm : Form
    {
        public ModificacionDietaFrm()
        {
            InitializeComponent();
        }
        ...
        private void textCodigo_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                textDescripcion.Text = d.Descripcion;
                textAutor.Text = d.Autor;
                FechaAltaDpk.Value = d.FechaAlta;

            }
            catch (NullReferenceException)
            {
                errorProvider1.SetError(textCodigo, "Dieta no existe");
